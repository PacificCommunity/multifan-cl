  ...
  const dvariable&  _vrho,const dvariable&  _vvar,int ic)
{
  ...
  symmetric_tridiagonal_dmatrix stdsinv=get_tridag_BH(crho,cvar,mmin,
     mmax);
...
//extern ccubic_spline_array * pccsa;
  ...
  ccubic_spline_array * pccsa)
{
  ...
  int nn=mmax-mmin+1;
  banded_lower_triangular_dmatrix bltd=pccsa->get_ltcholeski_inv(nn);

  banded_symmetric_dmatrix bsd2=mult_trans_mult(bltd);
  ...
  if (pps)
  {
    ...
    dmatrix Y=make_dmatrix(get_tridag_BH(0.9,1,1,6));
    cout  << endl << "Y"  << endl;
    cout  <<  Y  << endl;
    ad_exit(1);
   /*
  ...
  */
   ...
   /* 
    ...
    symmetric_tridiagonal_dmatrix std=get_tridag_BH(0.8,2.0,1,
      5);
  ...
  dvector eta_hat1=lognormal_ss_multinomial_newton_raphson(N,q,p,bltd,bsd2,
    eps);
...
static void df_lognormal_ss_multinomial_laplace_approximation_1(void)
{
  ...
  symmetric_tridiagonal_dmatrix BHess(mmin,mmax);
  BHess.initialize();
  symmetric_tridiagonal_dmatrix BSinv=get_tridag_BH(crho,cvar,
    mmin,mmax);
 ...
 //*******************************************************************8
  ...
  df_get_tridag_BH(crho,cvar,mmin,mmax,dfBSinv,dfrho,dfvar);
...
/*   make new copy of this which deals with arbitrary bandwidth
*/
/*   new copy of this which deals with arbitrary bandwidth */
/*   make new copy of this which deals with arbitrary bandwidth
*/
//   new copy of this which deals with arbitrary bandwidth
/*   make new copy of this which deals with arbitrary bandwidth
  ...
  const dvector& ww)
{
  ...
  int mmax=ww.indexmax();
  int bw=L.bandwidth();
  if (L.indexmin() != mmin || L.indexmax() != mmax ) 
  {
