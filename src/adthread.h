 ...
 *    this shows how multiple data items can be passed to a thread */
 ...
 // 
  ...
  public:
    ...
    MY_DOUBLE_TYPE get_double_from_master_nl(int sno);
    //void send_dvar_vector_to_slave(const dvar_vector &x,int sno);
    ...
    void memcpy(const MY_DOUBLE_TYPE &x,int sno);
    ...
    void send_double_to_master(const MY_DOUBLE_TYPE&, int);
    void send_double(const MY_DOUBLE_TYPE&, int);
    void send_double_to_slave(const MY_DOUBLE_TYPE &x,int sno);
    MY_DOUBLE_TYPE get_double_from_slave(int sno);
    MY_DOUBLE_TYPE get_double(int sno);
    MY_DOUBLE_TYPE get_double_from_master(int sno);
