...
//class df1b2variable;
  ...
  public:
    ...
    MY_DOUBLE_TYPE * get_u_x(void)const {return (MY_DOUBLE_TYPE*)  (&(v[1]));}
    MY_DOUBLE_TYPE * get_u_y(void)const {return (MY_DOUBLE_TYPE*)  (&(v[2]));}
    df1_two_variable& operator = (const df1_two_variable& v);
    df1_two_variable& operator = (MY_DOUBLE_TYPE v);
    df1_two_variable& operator += (const df1_two_variable& v);
    df1_two_variable& operator *= (const df1_two_variable& v);
    df1_two_variable& operator += (MY_DOUBLE_TYPE v);
    df1_two_variable& operator -= (const df1_two_variable& v);
  ...
  inline  MY_DOUBLE_TYPE value(const df1_two_variable& x) { return(MY_DOUBLE_TYPE)( *x.get_u()); }
  ...
  public:
    ...
    init_df1_two_variable(MY_DOUBLE_TYPE );
  };
...
*/
  ...
  df1_two_variable operator * (const df1_two_variable& x,
    const df1_two_variable& y);
  df1_two_variable operator * (MY_DOUBLE_TYPE x,
    const df1_two_variable& y);
  df1_two_variable operator * (const df1_two_variable& x,
    MY_DOUBLE_TYPE y);
  df1_two_variable operator / (const df1_two_variable& x,
  ...
  df1_two_variable operator / (const MY_DOUBLE_TYPE x,const df1_two_variable& y);

  df1_two_variable operator / (const df1_two_variable& x,
    const MY_DOUBLE_TYPE y);

  df1_two_variable operator + (const MY_DOUBLE_TYPE x,
    const df1_two_variable& y);
  ...
  df1_two_variable operator + (const df1_two_variable& x,
    const df1_two_variable& y);
  df1_two_variable operator - (MY_DOUBLE_TYPE x,const df1_two_variable& y);
  df1_two_variable operator - (const df1_two_variable& x,MY_DOUBLE_TYPE y);
