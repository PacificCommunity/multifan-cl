...
adstring set_outfile_name(dvar_len_fish_stock_history& fsh);
 ...
 void dvar_len_fish_stock_history::albacore_control_switches(void)
 {
   switch(++parest_flags(20))
   {
     ...
     case 17:
     {
       ...
       // setting parest_flags(30)=0 means this is the last automatic stage
       parest_flags(30)=0;
       delayed_outfile=set_outfile_name(*this);
       age_flags(50)=1;
       break;
